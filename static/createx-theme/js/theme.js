...
(function () {
  ...
  var stickyNavbar = (function () {
    ...
    if (
      navbarClass.contains("navbar-floating") &&
      navbarClass.contains("navbar-dark")
    ) {
  ...
  var stickySidebar = (function () {
    ...
    if (sidebar.length > 0) {
      ...
      for (var i = 0; i < sidebar.length; i++) {
        ...
        if (sidebar[i].dataset.sidebarStickyOptions !== undefined)
          userOptions = JSON.parse(sidebar[i].dataset.sidebarStickyOptions); // Combine default and user options into one object
  ...
  var countdown = (function () {
    ...
    var _loop4 = function _loop4(i) {
      var endDate = coundown[i].dataset.countdown,
        ...
        hoursVal = coundown[i].querySelector(
          ".countdown-hours .countdown-value"
        ),
        minutesVal = coundown[i].querySelector(
          ".countdown-minutes .countdown-value"
        ),
        secondsVal = coundown[i].querySelector(
  ...
  var progressRadial = (function () {
    ...
    for (var i = 0; i < progressRadial.length; i++) {
      // User options
      var userOptions = void 0;
      if (progressRadial[i].dataset.progressRadial.length > 0)
        userOptions = JSON.parse(progressRadial[i].dataset.progressRadial); // Combine default and user options into one object
      ...
      var progressRadialInit = new ProgressBar.Circle(
        progressRadial[i],
        options
    ...
    var _loop6 = function _loop6(i) {
      ...
      function filterListFunc() {
        ...
        for (var _i = 0; _i < filterItems.length; _i++) {
          var filterText =
            filterItems[_i].querySelector(".filter-item-text").innerHTML;
    ...
    for (var i = 0; i < toggles.length; i++) {
      toggles[i].addEventListener("click", function (e) {
        var targetEl = document.querySelector(
            e.currentTarget.dataset.bindedContent
          ),
