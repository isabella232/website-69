...
!(function () {
  ...
  null != (r = document.querySelector(".navbar-sticky")) &&
    ...
    (function () {
      ...
      if (0 < e.length)
        for (
          ...
          var a = void 0;
          void 0 !== e[r].dataset.sidebarStickyOptions &&
            (a = JSON.parse(e[r].dataset.sidebarStickyOptions));
          (a = _objectSpread(_objectSpread({}, t), a)),
            new StickySidebar(e[r], a);
        }
    })(),
    (function () {
      for (
    ...
    (function () {
      ...
      if (null !== e)
        for (
          ...
          var a = void 0;
          0 < e[r].dataset.progressRadial.length &&
            (a = JSON.parse(e[r].dataset.progressRadial));
          var n = _objectSpread(_objectSpread({}, t), a),
            n = new ProgressBar.Circle(e[r], n),
            a = null != a ? a.progress : 0.75;
          n.animate(a);
        }
    })(),
    (function () {
    ...
    (function () {
      for (
        var t = document.querySelectorAll(".filter"), e = 0;
        e < t.length;
        e++
      )
        (function (e) {
          ...
          r.addEventListener("keyup", function () {
            for (var e = r.value.toLowerCase(), t = 0; t < a.length; t++)
              -1 <
              a[t]
                .querySelector(".filter-item-text")
    ...
    (function () {
      for (
        var e = document.querySelectorAll("[data-binded-content]"),
          t = (document.querySelector(".binded-content"), 0);
        t < e.length;
        t++
      )
        e[t].addEventListener("click", function (e) {
    ...
    null !== (s = document.querySelector("[data-filters-columns]")) &&
